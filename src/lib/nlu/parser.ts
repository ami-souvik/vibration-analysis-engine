    ...
    const response = await ai.models.generateContent({
      ...
      config: {
        ...
        responseSchema: {
          type: Type.OBJECT,
          properties: {
            motor_rpm: { type: Type.NUMBER, description: "Running speed in RPM", nullable: true },
            male_lobes: { type: Type.INTEGER, description: "Number of lobes on male rotor", nullable: true },
            female_lobes: { type: Type.INTEGER, description: "Number of lobes on female rotor", nullable: true },
            foundation_type: { type: Type.STRING, description: "One of: 'Rigid', 'Flexible'", nullable: true },
            machine_group: {
              type: Type.STRING,
              description: "One of: 'Group 1 (Process Gas)', 'Group 2 (Oil-Free Air)', 'Group 3 (Oil-Flooded)'",
              nullable: true,
            },
            bearing_numbers: {
              type: Type.ARRAY,
              items: { type: Type.STRING },
              description: "List of bearing designations, e.g. ['7309 DE', 'NU 309']",
              nullable: true,
            },
            measured_peaks: {
              type: Type.ARRAY,
